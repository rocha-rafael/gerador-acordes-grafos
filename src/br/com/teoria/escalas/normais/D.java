...
public class D extends Escalas
{
	private List<NotaEscala> notasEscalaDmaior;

	public List<NotaEscala> getNotasEscalaDmaior()
	{
		return notasEscalaDmaior;
	}

	public void setNotasEscalaDmaior(List<NotaEscala> notasEscalaDmaior)
	{
		this.notasEscalaDmaior = notasEscalaDmaior;
	}
	...
	public D()
	{
		...
		NotaEscala D = new NotaEscala("D", 1.0);
		NotaEscala Dsustenido = new NotaEscala("D#", 1.5);
		NotaEscala E = new NotaEscala("E", 2.0);
		NotaEscala F = new NotaEscala("F", 2.5);
		NotaEscala Fsustenido = new NotaEscala("F#", 3.0);
		NotaEscala G = new NotaEscala("G", 3.5);
		NotaEscala Gsustenido = new NotaEscala("G#", 4.0);
		NotaEscala A = new NotaEscala("A", 4.5);
		NotaEscala Asustenido = new NotaEscala("A#", 5.0);
		NotaEscala B = new NotaEscala("B", 5.5);
		NotaEscala C = new NotaEscala("C", 6.0);
		NotaEscala Csusteinido = new NotaEscala("C#", 6.5);
		...
		this.setNotasEscalaDmaior(notasEscalaAdicionar);
	}
	...
	public List<String> formarAcorde(Double primeiraNota, Double segundaNota, Double terceiraNota, Double setimaNota)
	{
		...
		for(NotaEscala ne : this.getNotasEscalaDmaior())
		{

...
public class Gsustenido extends Escalas
{
	private List<NotaEscala> notasEscalaGsustenido;
	
	public List<NotaEscala> getNotasEscalaGsustenido()
	{
		return notasEscalaGsustenido;
	}

	public void setNotasEscalaGsustenido(List<NotaEscala> notasEscalaGsustenido)
	{
		this.notasEscalaGsustenido = notasEscalaGsustenido;
	}
	...
	public Gsustenido()
	{
		...
		NotaEscala Gsustenido = new NotaEscala("G#", 1.0);
		NotaEscala A = new NotaEscala("A", 1.5);
		NotaEscala Asustenido = new NotaEscala("A#", 2.0);
		NotaEscala B = new NotaEscala("B", 2.5);
		NotaEscala C = new NotaEscala("C", 3.0);
		NotaEscala Csusteinido = new NotaEscala("C#", 3.5);
		NotaEscala D = new NotaEscala("D", 4.0);
		NotaEscala Dsustenido = new NotaEscala("D#", 4.5);
		NotaEscala E = new NotaEscala("E", 5.0);
		NotaEscala F = new NotaEscala("F", 5.5);
		NotaEscala Fsustenido = new NotaEscala("F#", 6.0);
		NotaEscala G = new NotaEscala("G", 6.5);
		...
		this.setNotasEscalaGsustenido(notasEscalaAdicionar);
	}
	...
	public List<String> formarAcorde(Double primeiraNota, Double segundaNota, Double terceiraNota, Double setimaNota)
	{
		...
		for(NotaEscala ne : this.getNotasEscalaGsustenido())
		{
